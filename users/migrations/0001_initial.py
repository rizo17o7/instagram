    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_roles', models.CharField(choices=[('ordinary_+user', 'ordinary_+user'), ('manager', 'manager'), ('admin', 'admin')], default='ordinary_+user', max_length=31)),
                ('AUTH_TYPE', models.CharField(choices=[('via_phone', 'via_phone'), ('via_email', 'via_email')], max_length=31)),
                ('AUTH_STATUS', models.CharField(choices=[('new', 'new'), ('code-verified', 'code-verified'), ('done', 'done'), ('photo_step', 'photo_step')], default='new', max_length=31)),
